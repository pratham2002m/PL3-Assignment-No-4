# Generated by Django 4.0.2 on 2022-09-30 13:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('book', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='system.book')),
            ],
        ),
        migrations.CreateModel(
            name='Book_Issue',
            fields=[
                ...
                ('due_date', models.DateTimeField(default=datetime.datetime(2022, 10, 8, 19, 2, 22, 840269), help_text='Date the book is due to')),
                ...
                ('student', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='system.students')),
            ],
        ),
    ]
